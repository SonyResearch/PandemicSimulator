...
town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(GroceryStore, num=10, num_assignees=10, state_opts=dict(visitor_capacity=30)),
        LocationConfig(Office, num=50, num_assignees=150, state_opts=dict(visitor_capacity=0)),
        LocationConfig(School, num=30, num_assignees=4, state_opts=dict(visitor_capacity=300)),
        LocationConfig(Hospital, num=1, num_assignees=80, state_opts=dict(patient_capacity=100)),
        LocationConfig(RetailStore, num=15, num_assignees=10, state_opts=dict(visitor_capacity=30)),
        LocationConfig(HairSalon, num=20, num_assignees=3, state_opts=dict(visitor_capacity=5)),
        LocationConfig(Restaurant, num=20, num_assignees=6, state_opts=dict(visitor_capacity=30)),
        LocationConfig(Bar, num=10, num_assignees=8, state_opts=dict(visitor_capacity=30)),
...
above_medium_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(School, num=40, num_assignees=4, state_opts=dict(visitor_capacity=300)),
...
medium_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(School, num=20, num_assignees=4, state_opts=dict(visitor_capacity=300)),
...
small_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(School, num=10, num_assignees=4, state_opts=dict(visitor_capacity=300)),
...
tiny_town_config = PandemicSimConfig(
    ...
    location_configs=[
        ...
        LocationConfig(School, num=10, num_assignees=2, state_opts=dict(visitor_capacity=300)),
