...
town_population_params = PopulationParams(
    ...
    location_type_to_params={
        ...
        School: LocationParams(num=30, worker_capacity=4, visitor_capacity=30),
        ...
        Restaurant: LocationParams(num=16, worker_capacity=6, visitor_capacity=30),
        Bar: LocationParams(num=20, worker_capacity=8, visitor_capacity=30),
    },
    viz_scale=2)
...
above_medium_town_population_params = PopulationParams(
    ...
    location_type_to_params={
        ...
        School: LocationParams(num=40, worker_capacity=4, visitor_capacity=30),
        ...
        Bar: LocationParams(num=10, worker_capacity=4, visitor_capacity=12),
    },
    viz_scale=3)
...
medium_town_population_params = PopulationParams(
    ...
    location_type_to_params={
        ...
        School: LocationParams(num=20, worker_capacity=4, visitor_capacity=30),
        ...
        Bar: LocationParams(num=8, worker_capacity=3, visitor_capacity=10),
    },
    viz_scale=3)
...
small_town_population_params = PopulationParams(
    ...
    location_type_to_params={
        ...
        School: LocationParams(num=10, worker_capacity=4, visitor_capacity=30),
        ...
        Bar: LocationParams(num=2, worker_capacity=5, visitor_capacity=25),
    },
    viz_scale=3)
...
tiny_town_population_params = PopulationParams(
    ...
    location_type_to_params={
        ...
        School: LocationParams(num=10, worker_capacity=2, visitor_capacity=30),
        ...
        Bar: LocationParams(num=1, worker_capacity=3, visitor_capacity=6),
    },
    viz_scale=3)
