...
if __name__ == '__main__':
    name_to_strategy = {
        ...
        'S3': 3,
        'S4': 4,
        'S0-4-0': [StageSchedule(stage=4, end_day=20),
                   StageSchedule(stage=0, end_day=None)],
        'S0-4-0-FI': [StageSchedule(stage=4, end_day=20),
                      StageSchedule(stage=3, end_day=25),
                      StageSchedule(stage=2, end_day=30),
                      StageSchedule(stage=1, end_day=35),
                      StageSchedule(stage=0, end_day=None)],
        'S0-4-0-GI': [StageSchedule(stage=4, end_day=20),
                      StageSchedule(stage=3, end_day=35),
                      StageSchedule(stage=2, end_day=50),
                      StageSchedule(stage=1, end_day=65),
                      StageSchedule(stage=0, end_day=None)]
    }
